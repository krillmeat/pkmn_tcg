const cardData = {
    rg: {
        ...
        [new ABILITY("phantom curse","Once per turn, you may send [1] of your [opponent]'[s]% [basic energy] from their [discard] to their [lost zone].% Then, deal [{dmg}20] [{dmg}dmg] to this [PKMN]."),
